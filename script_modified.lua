...
TogglesFrame.Size = UDim2.new(1, 0, 0, 396)
...
local function UpdateLayout()
    if settingsCollapsed then
        ...
        Tween(ScrollList, {Size = UDim2.new(1, -10, 1, -250)})
        TogglesFrame.Visible = false
    else
        Tween(SettingsFrame, {Size = UDim2.new(1, 0, 0, 526), Position = UDim2.new(0, 0, 1, -526)})
        Tween(ScrollList, {Size = UDim2.new(1, -10, 1, -646)})
...
-- ── SPAM TARGET (Filter kata berakhiran tertentu, tetap tampilkan kata aman) ──
local SpamLabel = Instance.new("TextLabel", TogglesFrame)
SpamLabel.Text = "🎯 Spam Target (akhiran):"
SpamLabel.Font = Enum.Font.GothamMedium
SpamLabel.TextSize = 11
SpamLabel.TextColor3 = THEME.SubText
SpamLabel.Size = UDim2.new(0, 150, 0, 30)
SpamLabel.Position = UDim2.new(0, 8, 0, 148)
SpamLabel.BackgroundTransparency = 1
SpamLabel.TextXAlignment = Enum.TextXAlignment.Left

local SpamTargetBox = Instance.new("TextBox", TogglesFrame)
SpamTargetBox.Font = Enum.Font.Gotham
SpamTargetBox.TextSize = 13
SpamTargetBox.BackgroundColor3 = THEME.ItemBG
SpamTargetBox.Size = UDim2.new(0, 90, 0, 30)
SpamTargetBox.Position = UDim2.new(0, 160, 0, 148)
SpamTargetBox.PlaceholderText = "mis. tes"
...
Instance.new("UICorner", SpamTargetBox).CornerRadius = UDim.new(0, 6)

local SpamClearBtn = Instance.new("TextButton", TogglesFrame)
SpamClearBtn.Text = "✕"
SpamClearBtn.Font = Enum.Font.GothamBold
SpamClearBtn.TextSize = 14
SpamClearBtn.TextColor3 = Color3.fromRGB(255, 100, 100)
SpamClearBtn.BackgroundColor3 = THEME.ItemBG
SpamClearBtn.Size = UDim2.new(0, 30, 0, 30)
SpamClearBtn.Position = UDim2.new(0, 258, 0, 148)
Instance.new("UICorner", SpamClearBtn).CornerRadius = UDim.new(0, 6)

SpamTargetBox.FocusLost:Connect(function()
...
ManageWordsBtn.Position = UDim2.new(0, 8, 0, 220)
...
WordBrowserBtn.Position = UDim2.new(0, 8, 0, 258)
...
ServerBrowserBtn.Position = UDim2.new(0, 8, 0, 296)
