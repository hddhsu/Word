...
local function UpdateLayout()
    if settingsCollapsed then
        ...
        Tween(SettingsFrame, {Size = UDim2.new(1, 0, 0, 490), Position = UDim2.new(0, 0, 1, -490)})
        Tween(ScrollList, {Size = UDim2.new(1, -10, 1, -610)})
...
local BlatantBtn = CreateToggle("Blatant Mode: "..(isBlatant and "ON" or "OFF"), UDim2.new(0, 8, 0, 148), function()
...
local RiskyBtn = CreateToggle("Risky Mistakes: "..(riskyMistakes and "ON" or "OFF"), UDim2.new(0, 152, 0, 148), function()
